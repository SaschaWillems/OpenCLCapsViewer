...
#define STR(r) case r: return #r
			...
			STR(CL_DEVICE_UUID);
			STR(CL_DRIVER_UUID);
			STR(CL_DEVICE_LUID_VALID);
			STR(CL_DEVICE_LUID);
			STR(CL_DEVICE_NODE_MASK);
			...
			STR(CL_DEVICE_INTEGER_DOT_PRODUCT_CAPABILITIES);
			STR(CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT);
			STR(CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED);
			STR(CL_DEVICE_SPIRV_EXTENDED_INSTRUCTION_SETS);
			STR(CL_DEVICE_SPIRV_EXTENSIONS);
			STR(CL_DEVICE_SPIRV_CAPABILITIES);
			...
			// cl_khr_device_uuid uses the OpenCL 3.1 core enum values
			...
			// cl_khr_integer_dot_product uses the OpenCL 3.1 core enum values
